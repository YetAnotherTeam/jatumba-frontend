    ...
    return {
        ...
        execute: function() {
            EditorComponent = (function () {
                function EditorComponent(_router, _authService, _editorService, _editorSocketService) {
                    this._router = _router;
                    this._authService = _authService;
                    this._editorService = _editorService;
                    this._editorSocketService = _editorSocketService;
                    this.isPlay = false;
                ...
                EditorComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, auth_service_1.AuthService, editor_service_1.EditorService, editor_service_1.EditorSocketService])
                ], EditorComponent);
